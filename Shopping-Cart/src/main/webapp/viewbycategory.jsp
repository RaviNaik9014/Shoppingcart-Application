...
<style>
    body {
        min-height: 100%;
        background-image: url(https://img.freepik.com/premium-photo/pink-school-accessories-blue-background_106006-509.jpg);
...
<body>
    ...
    <div class="container mt-4">
        <form action="viewproductsbycategory" method="GET">
            <div class="form-group">
                <label for="category">Search Products by Category:</label>
    ...
    <div class="container mt-4">
        <table class="table">
            ...
            <tbody>
                <% 
                List<Product> products = (List<Product>) request.getAttribute("categorylist");
                if (products != null) {
                ...
                %>
                <tr>
                    <td colspan="5">No products found for this Category..</td>
                </tr>
                <% } %>
            </tbody>
        </table>
